...
/**
 * @extends ServiceEntityRepository<DateRange>
 *
...
class DateRangeRepository extends ServiceEntityRepository
{
    ...
    public function save(DateRange $entity, bool $flush = false): void
    {
    ...
    public function remove(DateRange $entity, bool $flush = false): void
    {
...
//    /**
//     * @return DateRange[] Returns an array of DateRange objects
//     */
...
//    public function findOneBySomeField($value): ?DateRange
//    {
//        return $this->createQueryBuilder('d')
//            ->andWhere('d.exampleField = :val')
//            ->setParameter('val', $value)
