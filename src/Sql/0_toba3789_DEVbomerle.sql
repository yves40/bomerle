...
--
-- Hôte : localhost:3306
-- Généré le : lun. 08 jan. 2024 à 08:33
...
(7, 'Sheffield', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius facere ab totam nemo et aut mollitia, at commodi ipsum veritatis! Dolorum rem facere ex suscipit optio fuga rerum cumque minima perferendis ullam provident, dolores quis alias reiciendis delectus minus modi, enim consequuntur id, asperiores voluptatem. Doloremque consequatur temporibus quasi provident eaque tempora culpa laudantium. Accusantium nostrum laudantium quia reiciendis nihil nemo officia sed sit dolore voluptate in ipsam blanditiis sapiente distinctio quo, iusto est eius similique! Unde nihil dolorem numquam at explicabo repellendus libero a officiis enim fuga ex ratione ab laborum adipisci, impedit natus distinctio ducimus repudiandae. Deserunt, magnam.', 'Sheffield'),
(8, 'Slipjoint', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius facere ab totam nemo et aut mollitia, at commodi ipsum veritatis! Dolorum rem facere ex suscipit optio fuga rerum cumque minima perferendis ullam provident, dolores quis alias reiciendis delectus minus modi, enim consequuntur id, asperiores voluptatem. Doloremque consequatur temporibus quasi provident eaque tempora culpa laudantium. Accusantium nostrum laudantium quia reiciendis nihil nemo officia sed sit dolore voluptate in ipsam blanditiis sapiente distinctio quo, iusto est eius similique! Unde nihil dolorem numquam at explicabo repellendus libero a officiis enim fuga ex ratione ab laborum adipisci, impedit natus distinctio ducimus repudiandae. Deserunt, magnam.', 'Slipjoint'),
(9, 'XVIIIème siècle', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius facere ab totam nemo et aut mollitia, at commodi ipsum veritatis! Dolorum rem facere ex suscipit optio fuga rerum cumque minima perferendis ullam provident, dolores quis alias reiciendis delectus minus modi, enim consequuntur id, asperiores voluptatem. Doloremque consequatur temporibus quasi provident eaque tempora culpa laudantium. Accusantium nostrum laudantium quia reiciendis nihil nemo officia sed sit dolore voluptate in ipsam blanditiis sapiente distinctio quo, iusto est eius similique! Unde nihil dolorem numquam at explicabo repellendus libero a officiis enim fuga ex ratione ab laborum adipisci, impedit natus distinctio ducimus repudiandae. Deserunt, magnam.', 'XVIIIème siècle'),
(10, 'Les Italiens', 'Je trouve aux couteaux régionaux italiens une excentricité rafraichissante qui les distingue fortement des couteaux régionaux français. Je vous propose ici des chimères créées autour des couteaux italiens en les mélangeant à des couteaux traditionnels français.', 'Les Italiens'),
(11, 'Mes salons', 'Les salons sont une bonne occasion pour moi d\'innover et de réaliser des créations libres. Vous trouverez ici la production présentées dans différents salons aux quatre coins de la France.', 'Mes salons'),
...
(3, 'Isabelle', 'Toubhans', 'i.toubhans@free.fr', 'Pluton with Jeff', '$2y$13$CGxmKwco23V9huYrpEclTuLuyp12KLkO4jiB/3uSZTpLlni7Qe7PK', '2023-12-27 11:31:17', NULL, '$2y$13$sOls5A9nYBTmbeai0Tw2dexh46ppr/uF5mjFBLIX8C0mVPlPgZfza', '2023-12-27 11:31:17'),
